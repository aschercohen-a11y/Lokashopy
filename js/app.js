  ...
  renderReviewsTab(provider) {
    ...
    return `
      ...
      <div class="external-reviews">
        <h4>Consultez nos avis sur :</h4>
        <div class="external-reviews-links">
          ${provider.googleReviewsUrl ? `
          <a href="${provider.googleReviewsUrl}" target="_blank" rel="noopener" class="external-review-btn google-btn">
          ...
          <a href="${provider.trustpilotUrl}" target="_blank" rel="noopener" class="external-review-btn trustpilot-btn">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
